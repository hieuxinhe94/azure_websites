...
public partial class _default : BlogEngine.Core.Web.Controls.BlogBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.RawUrl.ToLowerInvariant().Contains("categoryid="))
        {
            DisplayCategories();
        }
    ...
    public string FindFirstImgWithRegex(string content)
    {
    ...
    private void ProcessSearchEngine()
    {
        ...
        if (CrawlerUrl.Contains("?categoryid") ||
